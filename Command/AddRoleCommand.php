...
{
    protected static $defaultName = 'add-role';
    ...
    protected function execute(InputInterface $input, OutputInterface $output): ?int
    {
        ...
        if ($role !== 'ROLE_ADMIN' && $role !== 'ROLE_SUPER_ADMIN') {
            throw new \InvalidArgumentException(sprintf('Please check one of two roles: ROLE_ADMIN or ROLE_SUPER_ADMIN to set for "%s"', $username));
        }
        ...
        $output->writeln('Role ' . $role . ' was added to ' . $username);
